        ...
        <div>
            ...
            <div className="text-center">
                ...
                <div className="flex items-center mt-6 gap-x-3 justify-center">
                    ...
                    <button onClick={handleBackButton} class="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-[#1F2937] text-[#1F2937] text-white">
                        <span class="absolute w-64 h-0 transition-all duration-300 origin-center rotate-45 -translate-x-20 bg-[#1F2937] top-1/2 group-hover:h-64 group-hover:-translate-y-32 ease"></span>
                        <span class="relative text-[#1F2937] transition duration-300 group-hover:text-white ease flex items-center gap-2"><FaArrowLeftLong className="text-xl"></FaArrowLeftLong>Go back</span>
                    </button>
                    ...
                    <Link to='/'>
                        <button class="relative inline-flex items-center justify-center py-3 pl-8 pr-8 overflow-hidden font-semibold text-[#1F2937] transition-all duration-150 ease-in-out rounded hover:pl-8 hover:pr-8 bg-gray-50 group">
                            ...
                            <span class="relative w-full text-center transition-colors duration-200 ease-in-out group-hover:text-white">Take me home</span>
                        </button>
                    </Link>
                </div>
            </div>
